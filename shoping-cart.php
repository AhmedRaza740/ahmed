...
if(isset($_POST['addtocart'])){
	if(isset($_SESSION['finalcart'])){
		...
		if(in_array($_POST['p_Id'],$productId)){
			...
			$_SESSION['fianlcart'][$count] = array("p_Id"=>$_POST['p_Id'],"p_Name"=>$_POST['p_Name'],"p_Price"=>$_POST['p_Price'],"p_Des"=>$_POST['p_Des'],"p_Image"=>$_POST['p_Image'],"p_Qty"=>$_POST['num-product']);
